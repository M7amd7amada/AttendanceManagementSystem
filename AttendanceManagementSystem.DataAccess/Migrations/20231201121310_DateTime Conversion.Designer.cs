...
namespace AttendanceManagementSystem.DataAccess.Migrations
{
    ...
    [Migration("20231201121310_DateTime Conversion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AttendanceManagementSystem.Domain.Models.UserReport", b =>
                {
                    b.Property<Guid>("ReportId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AttendanceManagementSystem.Domain.Models.UserReport", b =>
                {
                    ...
                    b.HasOne("AttendanceManagementSystem.Domain.Models.User", "User")
                        .WithMany("UserReports")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
